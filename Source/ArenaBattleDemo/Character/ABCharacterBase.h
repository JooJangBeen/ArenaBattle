...
//델리게이트 자체를 인자로 사용할수 없기 때문에 구조체 선언이 필요함.
...
protected:
	...
	//타이머 시간 사이에 입력이 들어왔는지 여부를 확인 하는 함수.
	void ComboCheck();
...
protected:
	...
	//내부에서만 사용 할거여서 bool을사용한다.(bool을 사용한 경우 타입이 명확하게 보이기때문에 접두사에 b를 붙히지 않는다.)
